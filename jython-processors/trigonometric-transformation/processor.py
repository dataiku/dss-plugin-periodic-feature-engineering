...
for col_name in periodical_cols :
    trigonometric_mapping[col_name] = compute_trigonometric_labels(col_name, output_arg, choosed_functions, AVAILABLE_FUNCTIONS)

#Trigonometric transformer class instantiation :
trigonometric_transformer = PeriodicalFeaturesTransformer(choosed_functions=choosed_functions,
