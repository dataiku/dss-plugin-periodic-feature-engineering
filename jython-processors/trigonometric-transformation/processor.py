...
def process(row):
    ...
    try:
        ...
        log_message = "TypeError : {}".format(str(t.args))
        arg_val, cos_val, sin_val, tan_val = None, None, None, None

    except ValueError as v:
        log_message = "ValueError : {}".format(str(v.args))
        arg_val, cos_val, sin_val, tan_val = None, None, None, None
    ...
    row["{}_arg".format(periodic_column)] = arg_val
    row["{}_cos".format(periodic_column)] = cos_val
    row["{}_sin".format(periodic_column)] = sin_val
    row["{}_tan".format(periodic_column)] = tan_val
    row["{}_transformation_log".format(periodic_column)] = log_message
